   ...
   Al estar ocupada  ->       1     | [Product1,Product2]               |                 1     | [Product1,Product2, Product]      |
        la fila                     +-----------------------------------+                       +-----------------------------------+
            ...
            def:
                ...
                -validation: se valida la entrada de datos para evitar errores y/o el mal uso del programa
...
2. Preguntas
    ...
    ¿Por qué elegí el método de multiplicación sobre otros?
    ...
    ¿Por qué y que elegí como clave y valor?

    ¿Qué valor elegí como tamaño?

    Porque SI es un problema utilizar un tamaño de tabla fijo 